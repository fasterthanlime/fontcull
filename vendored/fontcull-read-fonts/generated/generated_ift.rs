...
impl fontcull_font_types::Scalar for PatchMapFieldPresenceFlags {
    type Raw = <u8 as fontcull_font_types::Scalar>::Raw;
...
impl fontcull_font_types::Scalar for EntryFormatFlags {
    type Raw = <u8 as fontcull_font_types::Scalar>::Raw;
    fn to_raw(self) -> Self::Raw {
        self.bits().to_raw()
    }
...
impl fontcull_font_types::Scalar for TablePatchFlags {
    type Raw = <u8 as fontcull_font_types::Scalar>::Raw;
    fn to_raw(self) -> Self::Raw {
        self.bits().to_raw()
    }
...
impl fontcull_font_types::Scalar for GlyphKeyedFlags {
    type Raw = <u8 as fontcull_font_types::Scalar>::Raw;
    fn to_raw(self) -> Self::Raw {
        self.bits().to_raw()
    }
