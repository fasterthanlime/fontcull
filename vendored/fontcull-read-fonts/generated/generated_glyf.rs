...
impl fontcull_font_types::Scalar for SimpleGlyphFlags {
...
impl fontcull_font_types::Scalar for CompositeGlyphFlags {
    type Raw = <u16 as fontcull_font_types::Scalar>::Raw;
    fn to_raw(self) -> Self::Raw {
        self.bits().to_raw()
    }
    fn from_raw(raw: Self::Raw) -> Self {
