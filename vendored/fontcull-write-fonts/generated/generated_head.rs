...
pub use fontcull_read_fonts::tables::head::{Flags, MacStyle};
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::head::Head<'a>> for Head {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::head::Head<'a>, _: FontData) -> Self {
        Head {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::head::Head<'a>> for Head {}

impl<'a> FontRead<'a> for Head {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::head::Head as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
