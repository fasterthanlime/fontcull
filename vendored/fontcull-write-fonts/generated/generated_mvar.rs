...
impl<'a> FromObjRef<fontcull_read_fonts::tables::mvar::Mvar<'a>> for Mvar {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::mvar::Mvar<'a>, _: FontData) -> Self {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::mvar::Mvar<'a>> for Mvar {}

impl<'a> FontRead<'a> for Mvar {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::mvar::Mvar as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
...
impl FromObjRef<fontcull_read_fonts::tables::mvar::ValueRecord> for ValueRecord {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::mvar::ValueRecord, _: FontData) -> Self {
        ValueRecord {
