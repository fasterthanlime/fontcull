...
pub use fontcull_read_fonts::tables::stat::AxisValueTableFlags;
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::stat::Stat<'a>> for Stat {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::stat::Stat<'a>, _: FontData) -> Self {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::stat::Stat<'a>> for Stat {}

impl<'a> FontRead<'a> for Stat {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::stat::Stat as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
...
impl FromObjRef<fontcull_read_fonts::tables::stat::AxisRecord> for AxisRecord {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::stat::AxisRecord, _: FontData) -> Self {
        AxisRecord {
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::stat::AxisValueArray<'a>> for AxisValueArray {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::stat::AxisValueArray<'a>, _: FontData) -> Self {
        AxisValueArray {
...
#[allow(clippy::needless_lifetimes)]
impl<'a> FromTableRef<fontcull_read_fonts::tables::stat::AxisValueArray<'a>> for AxisValueArray {}
...
impl FromObjRef<fontcull_read_fonts::tables::stat::AxisValue<'_>> for AxisValue {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::stat::AxisValue, _: FontData) -> Self {
        use fontcull_read_fonts::tables::stat::AxisValue as ObjRefType;
        match obj {
...
impl FromTableRef<fontcull_read_fonts::tables::stat::AxisValue<'_>> for AxisValue {}

impl<'a> FontRead<'a> for AxisValue {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::stat::AxisValue as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::stat::AxisValueFormat1<'a>> for AxisValueFormat1 {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::stat::AxisValueFormat1<'a>, _: FontData) -> Self {
        AxisValueFormat1 {
...
#[allow(clippy::needless_lifetimes)]
impl<'a> FromTableRef<fontcull_read_fonts::tables::stat::AxisValueFormat1<'a>> for AxisValueFormat1 {}

impl<'a> FontRead<'a> for AxisValueFormat1 {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::stat::AxisValueFormat1 as FontRead>::read(data)
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::stat::AxisValueFormat2<'a>> for AxisValueFormat2 {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::stat::AxisValueFormat2<'a>, _: FontData) -> Self {
        AxisValueFormat2 {
            axis_index: obj.axis_index(),
            flags: obj.flags(),
            value_name_id: obj.value_name_id(),
...
#[allow(clippy::needless_lifetimes)]
impl<'a> FromTableRef<fontcull_read_fonts::tables::stat::AxisValueFormat2<'a>> for AxisValueFormat2 {}

impl<'a> FontRead<'a> for AxisValueFormat2 {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::stat::AxisValueFormat2 as FontRead>::read(data)
            .map(|x| x.to_owned_table())
    }
}
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::stat::AxisValueFormat3<'a>> for AxisValueFormat3 {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::stat::AxisValueFormat3<'a>, _: FontData) -> Self {
        AxisValueFormat3 {
            axis_index: obj.axis_index(),
            flags: obj.flags(),
            value_name_id: obj.value_name_id(),
...
#[allow(clippy::needless_lifetimes)]
impl<'a> FromTableRef<fontcull_read_fonts::tables::stat::AxisValueFormat3<'a>> for AxisValueFormat3 {}

impl<'a> FontRead<'a> for AxisValueFormat3 {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::stat::AxisValueFormat3 as FontRead>::read(data)
            .map(|x| x.to_owned_table())
    }
}
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::stat::AxisValueFormat4<'a>> for AxisValueFormat4 {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::stat::AxisValueFormat4<'a>, _: FontData) -> Self {
        let offset_data = obj.offset_data();
        AxisValueFormat4 {
            flags: obj.flags(),
            value_name_id: obj.value_name_id(),
...
#[allow(clippy::needless_lifetimes)]
impl<'a> FromTableRef<fontcull_read_fonts::tables::stat::AxisValueFormat4<'a>> for AxisValueFormat4 {}

impl<'a> FontRead<'a> for AxisValueFormat4 {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::stat::AxisValueFormat4 as FontRead>::read(data)
            .map(|x| x.to_owned_table())
    }
}
...
impl FromObjRef<fontcull_read_fonts::tables::stat::AxisValueRecord> for AxisValueRecord {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::stat::AxisValueRecord, _: FontData) -> Self {
        AxisValueRecord {
            axis_index: obj.axis_index(),
            value: obj.value(),
        }
