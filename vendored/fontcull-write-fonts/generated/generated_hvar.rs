...
impl<'a> FromObjRef<fontcull_read_fonts::tables::hvar::Hvar<'a>> for Hvar {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::hvar::Hvar<'a>, _: FontData) -> Self {
        Hvar {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::hvar::Hvar<'a>> for Hvar {}

impl<'a> FontRead<'a> for Hvar {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::hvar::Hvar as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
