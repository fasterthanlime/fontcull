...
impl<'a> FromObjRef<fontcull_read_fonts::tables::maxp::Maxp<'a>> for Maxp {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::maxp::Maxp<'a>, _: FontData) -> Self {
        Maxp {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::maxp::Maxp<'a>> for Maxp {}

impl<'a> FontRead<'a> for Maxp {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::maxp::Maxp as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
