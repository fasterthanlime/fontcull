...
impl<'a> FromObjRef<fontcull_read_fonts::tables::name::Name<'a>> for Name {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::name::Name<'a>, _: FontData) -> Self {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::name::Name<'a>> for Name {}

impl<'a> FontRead<'a> for Name {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::name::Name as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
...
impl FromObjRef<fontcull_read_fonts::tables::name::LangTagRecord> for LangTagRecord {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::name::LangTagRecord, offset_data: FontData) -> Self {
        LangTagRecord {
...
impl FromObjRef<fontcull_read_fonts::tables::name::NameRecord> for NameRecord {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::name::NameRecord, offset_data: FontData) -> Self {
        NameRecord {
