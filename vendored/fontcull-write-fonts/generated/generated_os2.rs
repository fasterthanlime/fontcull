...
pub use fontcull_read_fonts::tables::os2::SelectionFlags;
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::os2::Os2<'a>> for Os2 {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::os2::Os2<'a>, _: FontData) -> Self {
        Os2 {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::os2::Os2<'a>> for Os2 {}

impl<'a> FontRead<'a> for Os2 {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::os2::Os2 as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
