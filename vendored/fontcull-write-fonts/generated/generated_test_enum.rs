...
pub use fontcull_read_fonts::codegen_test::enums::{MyEnum1, MyEnum2};
...
impl FromObjRef<fontcull_read_fonts::codegen_test::enums::MyRecord> for MyRecord {
    fn from_obj_ref(obj: &fontcull_read_fonts::codegen_test::enums::MyRecord, _: FontData) -> Self {
        MyRecord {
