...
impl<'a> FromObjRef<fontcull_read_fonts::tables::hdmx::Hdmx<'a>> for Hdmx {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::hdmx::Hdmx<'a>, _: FontData) -> Self {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::hdmx::Hdmx<'a>> for Hdmx {}
