...
impl<'a> FromObjRef<fontcull_read_fonts::tables::post::Post<'a>> for Post {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::post::Post<'a>, _: FontData) -> Self {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::post::Post<'a>> for Post {}

impl<'a> FontRead<'a> for Post {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::post::Post as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
