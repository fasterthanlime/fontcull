...
pub use fontcull_read_fonts::tables::variations::EntryFormat;
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::variations::TupleVariationHeader<'a>>
    for TupleVariationHeader
{
    fn from_obj_ref(
        obj: &fontcull_read_fonts::tables::variations::TupleVariationHeader<'a>,
        _: FontData,
    ) -> Self {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::variations::TupleVariationHeader<'a>>
    for TupleVariationHeader
{
}
...
impl FromObjRef<fontcull_read_fonts::tables::variations::Tuple<'_>> for Tuple {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::variations::Tuple, offset_data: FontData) -> Self {
        Tuple {
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::variations::DeltaSetIndexMapFormat0<'a>>
    for DeltaSetIndexMapFormat0
{
    fn from_obj_ref(
        obj: &fontcull_read_fonts::tables::variations::DeltaSetIndexMapFormat0<'a>,
        _: FontData,
    ) -> Self {
        let offset_data = obj.offset_data();
...
#[allow(clippy::needless_lifetimes)]
impl<'a> FromTableRef<fontcull_read_fonts::tables::variations::DeltaSetIndexMapFormat0<'a>>
    for DeltaSetIndexMapFormat0
{
}
...
impl<'a> FontRead<'a> for DeltaSetIndexMapFormat0 {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::variations::DeltaSetIndexMapFormat0 as FontRead>::read(data)
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::variations::DeltaSetIndexMapFormat1<'a>>
    for DeltaSetIndexMapFormat1
{
    fn from_obj_ref(
        obj: &fontcull_read_fonts::tables::variations::DeltaSetIndexMapFormat1<'a>,
        _: FontData,
    ) -> Self {
        let offset_data = obj.offset_data();
...
#[allow(clippy::needless_lifetimes)]
impl<'a> FromTableRef<fontcull_read_fonts::tables::variations::DeltaSetIndexMapFormat1<'a>>
    for DeltaSetIndexMapFormat1
{
}
...
impl<'a> FontRead<'a> for DeltaSetIndexMapFormat1 {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::variations::DeltaSetIndexMapFormat1 as FontRead>::read(data)
            .map(|x| x.to_owned_table())
    }
}
...
impl FromObjRef<fontcull_read_fonts::tables::variations::DeltaSetIndexMap<'_>> for DeltaSetIndexMap {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::variations::DeltaSetIndexMap, _: FontData) -> Self {
        use fontcull_read_fonts::tables::variations::DeltaSetIndexMap as ObjRefType;
        match obj {
...
impl FromTableRef<fontcull_read_fonts::tables::variations::DeltaSetIndexMap<'_>> for DeltaSetIndexMap {}

impl<'a> FontRead<'a> for DeltaSetIndexMap {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::variations::DeltaSetIndexMap as FontRead>::read(data)
            .map(|x| x.to_owned_table())
    }
}
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::variations::VariationRegionList<'a>>
    for VariationRegionList
{
    fn from_obj_ref(
        obj: &fontcull_read_fonts::tables::variations::VariationRegionList<'a>,
        _: FontData,
    ) -> Self {
        let offset_data = obj.offset_data();
        VariationRegionList {
...
#[allow(clippy::needless_lifetimes)]
impl<'a> FromTableRef<fontcull_read_fonts::tables::variations::VariationRegionList<'a>>
    for VariationRegionList
{
}
...
impl<'a> FontRead<'a> for VariationRegionList {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::variations::VariationRegionList as FontRead>::read(data)
            .map(|x| x.to_owned_table())
    }
}
...
impl FromObjRef<fontcull_read_fonts::tables::variations::VariationRegion<'_>> for VariationRegion {
    fn from_obj_ref(
        obj: &fontcull_read_fonts::tables::variations::VariationRegion,
...
impl FromObjRef<fontcull_read_fonts::tables::variations::RegionAxisCoordinates> for RegionAxisCoordinates {
    fn from_obj_ref(
        obj: &fontcull_read_fonts::tables::variations::RegionAxisCoordinates,
        _: FontData,
    ) -> Self {
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::variations::ItemVariationStore<'a>> for ItemVariationStore {
    fn from_obj_ref(
        obj: &fontcull_read_fonts::tables::variations::ItemVariationStore<'a>,
        _: FontData,
    ) -> Self {
        ItemVariationStore {
...
#[allow(clippy::needless_lifetimes)]
impl<'a> FromTableRef<fontcull_read_fonts::tables::variations::ItemVariationStore<'a>>
...
impl<'a> FontRead<'a> for ItemVariationStore {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::variations::ItemVariationStore as FontRead>::read(data)
            .map(|x| x.to_owned_table())
    }
}
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::variations::ItemVariationData<'a>> for ItemVariationData {
    fn from_obj_ref(
        obj: &fontcull_read_fonts::tables::variations::ItemVariationData<'a>,
        _: FontData,
    ) -> Self {
        let offset_data = obj.offset_data();
        ItemVariationData {
...
#[allow(clippy::needless_lifetimes)]
impl<'a> FromTableRef<fontcull_read_fonts::tables::variations::ItemVariationData<'a>> for ItemVariationData {}

impl<'a> FontRead<'a> for ItemVariationData {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::variations::ItemVariationData as FontRead>::read(data)
            .map(|x| x.to_owned_table())
    }
}
