...
pub use fontcull_read_fonts::codegen_test::conditions::GotFlags;
...
impl<'a> FromObjRef<fontcull_read_fonts::codegen_test::conditions::MajorMinorVersion<'a>>
    for MajorMinorVersion
{
    fn from_obj_ref(
        obj: &fontcull_read_fonts::codegen_test::conditions::MajorMinorVersion<'a>,
        _: FontData,
    ) -> Self {
        MajorMinorVersion {
            version: obj.version(),
...
impl<'a> FromTableRef<fontcull_read_fonts::codegen_test::conditions::MajorMinorVersion<'a>>
    for MajorMinorVersion
{
}
...
impl<'a> FontRead<'a> for MajorMinorVersion {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::codegen_test::conditions::MajorMinorVersion as FontRead>::read(data)
...
impl<'a> FromObjRef<fontcull_read_fonts::codegen_test::conditions::FlagDay<'a>> for FlagDay {
    fn from_obj_ref(obj: &fontcull_read_fonts::codegen_test::conditions::FlagDay<'a>, _: FontData) -> Self {
        FlagDay {
            volume: obj.volume(),
            flags: obj.flags(),
            foo: obj.foo(),
...
#[allow(clippy::needless_lifetimes)]
impl<'a> FromTableRef<fontcull_read_fonts::codegen_test::conditions::FlagDay<'a>> for FlagDay {}

impl<'a> FontRead<'a> for FlagDay {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::codegen_test::conditions::FlagDay as FontRead>::read(data)
            .map(|x| x.to_owned_table())
    }
}
...
impl<'a> FromObjRef<fontcull_read_fonts::codegen_test::conditions::FieldsAfterConditionals<'a>>
    for FieldsAfterConditionals
{
    fn from_obj_ref(
        obj: &fontcull_read_fonts::codegen_test::conditions::FieldsAfterConditionals<'a>,
        _: FontData,
    ) -> Self {
...
#[allow(clippy::needless_lifetimes)]
impl<'a> FromTableRef<fontcull_read_fonts::codegen_test::conditions::FieldsAfterConditionals<'a>>
    for FieldsAfterConditionals
{
}
...
impl<'a> FontRead<'a> for FieldsAfterConditionals {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::codegen_test::conditions::FieldsAfterConditionals as FontRead>::read(data)
            .map(|x| x.to_owned_table())
    }
}
