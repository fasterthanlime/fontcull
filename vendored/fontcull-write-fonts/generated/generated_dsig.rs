...
pub use fontcull_read_fonts::tables::dsig::PermissionFlags;
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::dsig::Dsig<'a>> for Dsig {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::dsig::Dsig<'a>, _: FontData) -> Self {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::dsig::Dsig<'a>> for Dsig {}

impl<'a> FontRead<'a> for Dsig {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::dsig::Dsig as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
...
impl FromObjRef<fontcull_read_fonts::tables::dsig::SignatureRecord> for SignatureRecord {
    fn from_obj_ref(
        obj: &fontcull_read_fonts::tables::dsig::SignatureRecord,
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::dsig::SignatureBlockFormat1<'a>> for SignatureBlockFormat1 {
    fn from_obj_ref(
        obj: &fontcull_read_fonts::tables::dsig::SignatureBlockFormat1<'a>,
        _: FontData,
    ) -> Self {
        let offset_data = obj.offset_data();
...
#[allow(clippy::needless_lifetimes)]
impl<'a> FromTableRef<fontcull_read_fonts::tables::dsig::SignatureBlockFormat1<'a>>
...
impl<'a> FontRead<'a> for SignatureBlockFormat1 {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::dsig::SignatureBlockFormat1 as FontRead>::read(data)
