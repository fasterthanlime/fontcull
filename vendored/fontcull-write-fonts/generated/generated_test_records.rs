...
impl<'a> FromObjRef<fontcull_read_fonts::codegen_test::records::BasicTable<'a>> for BasicTable {
    fn from_obj_ref(obj: &fontcull_read_fonts::codegen_test::records::BasicTable<'a>, _: FontData) -> Self {
...
impl<'a> FromTableRef<fontcull_read_fonts::codegen_test::records::BasicTable<'a>> for BasicTable {}

impl<'a> FontRead<'a> for BasicTable {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::codegen_test::records::BasicTable as FontRead>::read(data)
...
impl FromObjRef<fontcull_read_fonts::codegen_test::records::SimpleRecord> for SimpleRecord {
    fn from_obj_ref(obj: &fontcull_read_fonts::codegen_test::records::SimpleRecord, _: FontData) -> Self {
        SimpleRecord {
            val1: obj.val1(),
            va2: obj.va2(),
        }
...
impl FromObjRef<fontcull_read_fonts::codegen_test::records::ContainsArrays<'_>> for ContainsArrays {
    fn from_obj_ref(
        obj: &fontcull_read_fonts::codegen_test::records::ContainsArrays,
...
impl FromObjRef<fontcull_read_fonts::codegen_test::records::ContainsOffsets> for ContainsOffsets {
    fn from_obj_ref(
        obj: &fontcull_read_fonts::codegen_test::records::ContainsOffsets,
        offset_data: FontData,
    ) -> Self {
        ContainsOffsets {
...
impl<'a> FromObjRef<fontcull_read_fonts::codegen_test::records::VarLenItem<'a>> for VarLenItem {
    fn from_obj_ref(obj: &fontcull_read_fonts::codegen_test::records::VarLenItem<'a>, _: FontData) -> Self {
        let offset_data = obj.offset_data();
        VarLenItem {
            length: obj.length(),
...
#[allow(clippy::needless_lifetimes)]
impl<'a> FromTableRef<fontcull_read_fonts::codegen_test::records::VarLenItem<'a>> for VarLenItem {}

impl<'a> FontRead<'a> for VarLenItem {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::codegen_test::records::VarLenItem as FontRead>::read(data)
            .map(|x| x.to_owned_table())
    }
}
