...
impl<'a> FromObjRef<fontcull_read_fonts::tables::cff2::Cff2Header<'a>> for Cff2Header {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::cff2::Cff2Header<'a>, _: FontData) -> Self {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::cff2::Cff2Header<'a>> for Cff2Header {}

impl<'a> FontRead<'a> for Cff2Header {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::cff2::Cff2Header as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
