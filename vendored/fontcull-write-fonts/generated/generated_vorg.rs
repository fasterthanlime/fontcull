...
impl<'a> FromObjRef<fontcull_read_fonts::tables::vorg::Vorg<'a>> for Vorg {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::vorg::Vorg<'a>, _: FontData) -> Self {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::vorg::Vorg<'a>> for Vorg {}

impl<'a> FontRead<'a> for Vorg {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::vorg::Vorg as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
...
impl FromObjRef<fontcull_read_fonts::tables::vorg::VertOriginYMetrics> for VertOriginYMetrics {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::vorg::VertOriginYMetrics, _: FontData) -> Self {
        VertOriginYMetrics {
