...
pub use fontcull_read_fonts::tables::cpal::PaletteType;
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::cpal::Cpal<'a>> for Cpal {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::cpal::Cpal<'a>, _: FontData) -> Self {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::cpal::Cpal<'a>> for Cpal {}

impl<'a> FontRead<'a> for Cpal {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::cpal::Cpal as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
...
impl FromObjRef<fontcull_read_fonts::tables::cpal::ColorRecord> for ColorRecord {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::cpal::ColorRecord, _: FontData) -> Self {
        ColorRecord {
            blue: obj.blue(),
            green: obj.green(),
            red: obj.red(),
