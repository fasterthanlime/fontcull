...
impl<'a> FromObjRef<fontcull_read_fonts::tables::avar::Avar<'a>> for Avar {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::avar::Avar<'a>, _: FontData) -> Self {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::avar::Avar<'a>> for Avar {}

impl<'a> FontRead<'a> for Avar {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::avar::Avar as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
...
impl FromObjRef<fontcull_read_fonts::tables::avar::SegmentMaps<'_>> for SegmentMaps {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::avar::SegmentMaps, offset_data: FontData) -> Self {
        SegmentMaps {
...
impl FromObjRef<fontcull_read_fonts::tables::avar::AxisValueMap> for AxisValueMap {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::avar::AxisValueMap, _: FontData) -> Self {
        AxisValueMap {
