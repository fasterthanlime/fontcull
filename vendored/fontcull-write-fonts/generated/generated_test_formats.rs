...
impl<'a> FromObjRef<fontcull_read_fonts::codegen_test::formats::Table1<'a>> for Table1 {
    fn from_obj_ref(obj: &fontcull_read_fonts::codegen_test::formats::Table1<'a>, _: FontData) -> Self {
        Table1 {
            heft: obj.heft(),
            flex: obj.flex(),
        }
...
impl<'a> FromTableRef<fontcull_read_fonts::codegen_test::formats::Table1<'a>> for Table1 {}

impl<'a> FontRead<'a> for Table1 {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::codegen_test::formats::Table1 as FontRead>::read(data)
...
impl<'a> FromObjRef<fontcull_read_fonts::codegen_test::formats::Table2<'a>> for Table2 {
    fn from_obj_ref(obj: &fontcull_read_fonts::codegen_test::formats::Table2<'a>, _: FontData) -> Self {
...
#[allow(clippy::needless_lifetimes)]
impl<'a> FromTableRef<fontcull_read_fonts::codegen_test::formats::Table2<'a>> for Table2 {}

impl<'a> FontRead<'a> for Table2 {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::codegen_test::formats::Table2 as FontRead>::read(data)
            .map(|x| x.to_owned_table())
    }
}
...
impl<'a> FromObjRef<fontcull_read_fonts::codegen_test::formats::Table3<'a>> for Table3 {
    fn from_obj_ref(obj: &fontcull_read_fonts::codegen_test::formats::Table3<'a>, _: FontData) -> Self {
        Table3 {
...
#[allow(clippy::needless_lifetimes)]
impl<'a> FromTableRef<fontcull_read_fonts::codegen_test::formats::Table3<'a>> for Table3 {}

impl<'a> FontRead<'a> for Table3 {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::codegen_test::formats::Table3 as FontRead>::read(data)
            .map(|x| x.to_owned_table())
    }
}
...
impl FromObjRef<fontcull_read_fonts::codegen_test::formats::MyTable<'_>> for MyTable {
    fn from_obj_ref(obj: &fontcull_read_fonts::codegen_test::formats::MyTable, _: FontData) -> Self {
        use fontcull_read_fonts::codegen_test::formats::MyTable as ObjRefType;
        match obj {
...
impl FromTableRef<fontcull_read_fonts::codegen_test::formats::MyTable<'_>> for MyTable {}

impl<'a> FontRead<'a> for MyTable {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::codegen_test::formats::MyTable as FontRead>::read(data)
            .map(|x| x.to_owned_table())
    }
}
