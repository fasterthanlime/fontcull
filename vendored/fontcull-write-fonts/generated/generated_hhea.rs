...
impl<'a> FromObjRef<fontcull_read_fonts::tables::hhea::Hhea<'a>> for Hhea {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::hhea::Hhea<'a>, _: FontData) -> Self {
        Hhea {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::hhea::Hhea<'a>> for Hhea {}

impl<'a> FontRead<'a> for Hhea {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::hhea::Hhea as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
