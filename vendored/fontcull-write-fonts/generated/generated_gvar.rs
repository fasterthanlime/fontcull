...
pub use fontcull_read_fonts::tables::gvar::GvarFlags;
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::gvar::SharedTuples<'a>> for SharedTuples {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::gvar::SharedTuples<'a>, _: FontData) -> Self {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::gvar::SharedTuples<'a>> for SharedTuples {}
