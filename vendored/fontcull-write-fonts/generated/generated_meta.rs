...
impl<'a> FromObjRef<fontcull_read_fonts::tables::meta::Meta<'a>> for Meta {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::meta::Meta<'a>, _: FontData) -> Self {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::meta::Meta<'a>> for Meta {}

impl<'a> FontRead<'a> for Meta {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::meta::Meta as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
