...
impl<'a> FromObjRef<fontcull_read_fonts::tables::cff::CffHeader<'a>> for CffHeader {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::cff::CffHeader<'a>, _: FontData) -> Self {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::cff::CffHeader<'a>> for CffHeader {}

impl<'a> FontRead<'a> for CffHeader {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::cff::CffHeader as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
