...
impl<'a> FromObjRef<fontcull_read_fonts::tables::vhea::Vhea<'a>> for Vhea {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::vhea::Vhea<'a>, _: FontData) -> Self {
        Vhea {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::vhea::Vhea<'a>> for Vhea {}

impl<'a> FontRead<'a> for Vhea {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::vhea::Vhea as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
