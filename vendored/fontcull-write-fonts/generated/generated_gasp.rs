...
pub use fontcull_read_fonts::tables::gasp::GaspRangeBehavior;
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::gasp::Gasp<'a>> for Gasp {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::gasp::Gasp<'a>, _: FontData) -> Self {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::gasp::Gasp<'a>> for Gasp {}

impl<'a> FontRead<'a> for Gasp {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::gasp::Gasp as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
...
impl FromObjRef<fontcull_read_fonts::tables::gasp::GaspRange> for GaspRange {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::gasp::GaspRange, _: FontData) -> Self {
        GaspRange {
