...
impl<'a> FromObjRef<fontcull_read_fonts::tables::vmtx::Vmtx<'a>> for Vmtx {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::vmtx::Vmtx<'a>, _: FontData) -> Self {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::vmtx::Vmtx<'a>> for Vmtx {}
