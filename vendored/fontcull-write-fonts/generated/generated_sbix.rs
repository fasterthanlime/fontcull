...
pub use fontcull_read_fonts::tables::sbix::HeaderFlags;
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::sbix::Sbix<'a>> for Sbix {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::sbix::Sbix<'a>, _: FontData) -> Self {
        Sbix {
            flags: obj.flags(),
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::sbix::Sbix<'a>> for Sbix {}
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::sbix::Strike<'a>> for Strike {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::sbix::Strike<'a>, _: FontData) -> Self {
...
#[allow(clippy::needless_lifetimes)]
impl<'a> FromTableRef<fontcull_read_fonts::tables::sbix::Strike<'a>> for Strike {}
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::sbix::GlyphData<'a>> for GlyphData {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::sbix::GlyphData<'a>, _: FontData) -> Self {
        let offset_data = obj.offset_data();
        GlyphData {
...
#[allow(clippy::needless_lifetimes)]
impl<'a> FromTableRef<fontcull_read_fonts::tables::sbix::GlyphData<'a>> for GlyphData {}

impl<'a> FontRead<'a> for GlyphData {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::sbix::GlyphData as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
