...
impl<'a> FromObjRef<fontcull_read_fonts::tables::hmtx::Hmtx<'a>> for Hmtx {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::hmtx::Hmtx<'a>, _: FontData) -> Self {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::hmtx::Hmtx<'a>> for Hmtx {}
...
impl FromObjRef<fontcull_read_fonts::tables::hmtx::LongMetric> for LongMetric {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::hmtx::LongMetric, _: FontData) -> Self {
        LongMetric {
            advance: obj.advance(),
