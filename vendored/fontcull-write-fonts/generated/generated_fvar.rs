...
impl<'a> FromObjRef<fontcull_read_fonts::tables::fvar::Fvar<'a>> for Fvar {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::fvar::Fvar<'a>, _: FontData) -> Self {
        Fvar {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::fvar::Fvar<'a>> for Fvar {}

impl<'a> FontRead<'a> for Fvar {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::fvar::Fvar as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::fvar::AxisInstanceArrays<'a>> for AxisInstanceArrays {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::fvar::AxisInstanceArrays<'a>, _: FontData) -> Self {
...
#[allow(clippy::needless_lifetimes)]
impl<'a> FromTableRef<fontcull_read_fonts::tables::fvar::AxisInstanceArrays<'a>> for AxisInstanceArrays {}
...
impl FromObjRef<fontcull_read_fonts::tables::fvar::VariationAxisRecord> for VariationAxisRecord {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::fvar::VariationAxisRecord, _: FontData) -> Self {
        VariationAxisRecord {
