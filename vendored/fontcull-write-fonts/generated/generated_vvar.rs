...
impl<'a> FromObjRef<fontcull_read_fonts::tables::vvar::Vvar<'a>> for Vvar {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::vvar::Vvar<'a>, _: FontData) -> Self {
        Vvar {
...
impl<'a> FromTableRef<fontcull_read_fonts::tables::vvar::Vvar<'a>> for Vvar {}

impl<'a> FontRead<'a> for Vvar {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <fontcull_read_fonts::tables::vvar::Vvar as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
