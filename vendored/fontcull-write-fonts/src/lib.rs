...
//! `fontcull_read_fonts::tables::gpos`, and one defined in `fontcull_write_fonts::tables::gpos`.
//!
...
//! use fontcull_write_fonts::{from_obj::ToOwnedTable, tables::head::Head, types::LongDateTime};
//! // ...
//! # let font: FontRef<'static> = todo!();
//! # fn seconds_since_font_epoch() -> fontcull_font_types::LongDateTime { todo!() }
...
//! ```no_run
//! use fontcull_write_fonts::{tables::hhea::Hhea, types::{FWord, UfWord}};
//!
//! let my_table = Hhea {
...
//! };
//!
//! let _bytes = fontcull_write_fonts::dump_table(&my_table).expect("failed to write bytes");
//! ```
//!
...
//! [`FontRead`]: fontcull_read_fonts::FontRead
...
#[cfg(feature = "read")]
pub extern crate fontcull_read_fonts as read;
