...
pub use fontcull_read_fonts::tables::variations::{DeltaRunType, TupleIndex, TupleVariationCount};
...
impl<'a> FromObjRef<Option<fontcull_read_fonts::tables::variations::Tuple<'a>>> for Vec<F2Dot14> {
    fn from_obj_ref(
        from: &Option<fontcull_read_fonts::tables::variations::Tuple<'a>>,
        _data: FontData,
    ) -> Self {
        from.as_ref()
