...
use fontcull_read_fonts::tables::name::{Encoding, MacRomanMapping};
...
impl FromObjRef<fontcull_read_fonts::tables::name::NameString<'_>> for String {
    fn from_obj_ref(obj: &fontcull_read_fonts::tables::name::NameString<'_>, _: FontData) -> Self {
        obj.chars().collect()
    }
}

impl FromTableRef<fontcull_read_fonts::tables::name::NameString<'_>> for String {}
...
mod tests {
    ...
    fn mac_str_length() {
        ...
        let load = fontcull_read_fonts::tables::name::Name::read(FontData::new(&bytes)).unwrap();
