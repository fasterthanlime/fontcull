...
use fontcull_read_fonts::{FontRead, TopLevelTable};
use kurbo::Rect;
...
impl<'a> FromObjRef<fontcull_read_fonts::tables::glyf::Glyph<'a>> for Glyph {
    fn from_obj_ref(
        from: &fontcull_read_fonts::tables::glyf::Glyph<'a>,
        data: fontcull_read_fonts::FontData,
    ) -> Self {
        match from {
            fontcull_read_fonts::tables::glyf::Glyph::Simple(glyph) => {
                Self::Simple(SimpleGlyph::from_obj_ref(glyph, data))
            }
            fontcull_read_fonts::tables::glyf::Glyph::Composite(glyph) => {
...
impl FromTableRef<fontcull_read_fonts::tables::glyf::Glyph<'_>> for Glyph {}

impl<'a> FontRead<'a> for Glyph {
    fn read(
        data: fontcull_read_fonts::FontData<'a>,
    ) -> Result<Self, fontcull_read_fonts::ReadError> {
        fontcull_read_fonts::tables::glyf::Glyph::read(data).map(|g| Glyph::from_table_ref(&g))
    }
}
