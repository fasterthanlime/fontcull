...
super::layout::table_newtype!(
    ...
    SequenceContext,
    fontcull_read_fonts::tables::layout::SequenceContext<'a>
);

super::layout::table_newtype!(
    PositionChainContext,
    ChainedSequenceContext,
    fontcull_read_fonts::tables::layout::ChainedSequenceContext<'a>
);
...
impl<'a> FontRead<'a> for PositionLookup {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        fontcull_read_fonts::tables::gpos::PositionLookup::read(data).map(|x| x.to_owned_table())
    }
}
...
mod tests {
    ...
    use fontcull_read_fonts::tables::{gpos as read_gpos, layout::LookupFlag};
